...
import { AUDIO_ACCEPT, MAX_REFERENCE_BYTES, REFERENCE_MIN_SEC } from "@/lib/params";
    ...
    <div className="reference">
      ...
      {source === "upload" && (
        <FileDrop
          ...
          label="Giọng mẫu"
          hint={`Từ ${REFERENCE_MIN_SEC}s, một người nói, không nhạc nền · dài hơn cũng được, hệ thống tự lấy đoạn rõ nhất`}
          disabled={disabled}
        />
      )}
